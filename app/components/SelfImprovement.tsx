...
const SelfImprovement = () => {
  return (
    <section className="px-4 sm:px-10 lg:px-20 mt-10 mb-24">
      <div className="flex flex-col md:flex-row justify-between items-center">
        ...
        >
          ...
          <div className="text-4xl sm:text-5xl lg:text-6xl pb-3 font-bold text-black">
      ...
      <div className="timeline px-4 sm:px-10 lg:px-20 pt-14 h-96 overflow-y-scroll">
        <div className="border-l-2 border-l-violet-300 flex flex-col gap-16">
          <Reveal keyframes={customAnimation}>
            {[...Array(8)].map((val, index) => {
              return (
                <div key={index}>
                  <motion.div className="max-w-[20rem] sm:max-w-[30rem] lg:max-w-[40rem] relative align-top pl-8">
                    <div style={{ left: "-12px" }} className="absolute">🟣</div>
                    <p className="text-lg sm:text-xl font-bold">It&apos;s not easy as 1-2-3</p>
