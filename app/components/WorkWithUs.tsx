...
const WorkWithUs = () => {
  return (
    <div className="px-4 sm:px-10 lg:px-20 my-16 sm:my-32">
      <section className="mt-16 rounded-2xl bg-violet-100 p-6 sm:p-12 lg:px-16">
        <div className="flex flex-col sm:flex-row justify-between items-center text-3xl sm:text-5xl font-bold text-center sm:text-left">
          <motion.div
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true }}
        ...
        <div className="mt-12 flex flex-col lg:flex-row gap-10 lg:gap-20 overflow-hidden">
          <div className="grow">
            <div className="rounded-2xl bg-white pt-8 max-w-full lg:max-w-[30rem] shadow-lg mx-auto lg:mx-0">
              <motion.div
          ...
          <div className="flex flex-col gap-5 max-h-[75vh] overflow-y-auto pr-0 lg:pr-6 custom-scrollbar">
