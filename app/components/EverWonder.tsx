...
const EverWonder = () => {
  return (
    <section className="mt-16 mb-32 rounded-3xl bg-blue-50 p-10 mx-4 sm:mx-8 md:mx-16 lg:mx-24">
      <motion.div
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true }}
      ...
      >
        ...
        <h1 className="text-2xl sm:text-3xl md:text-[2.4rem] font-bold text-center mt-4">
          Ever wondered what others think of you?
        </h1>
      </motion.div>
      <div className="mt-8 flex flex-col lg:flex-row justify-center relative">
        <div className="absolute top-[1.5rem] w-full lg:w-[780px] text-transparent border-t border-yellow-700 h-4 border-dashed"></div>
        <div className="flex flex-col lg:flex-row justify-evenly w-full lg:w-[70rem] z-[10]">
      ...
      <div className="flex justify-center">
        <div className="mt-16 shadow bg-white rounded-xl w-full lg:w-[50rem] p-6 py-24 relative">
          <div className="flex justify-between">
            ...
            <div className="h-4 w-4 rounded-full bg-blue-400 z-10 relative">
              ...
              >
                <div className="absolute whitespace-nowrap text-white p-3 bg-blue-400 rounded top-[2rem] left-[80%] lg:left-[82%]">
                  Anonymous 1
                </div>
              </motion.div>
            </div>
            ...
            <div className="h-4 w-4 rounded-full bg-green-400 z-10 relative">
              ...
              >
                <div className="absolute whitespace-nowrap text-white p-3 bg-green-400 rounded top-[2rem] left-[80%] lg:left-[82%]">
                  Anonymous 3
                </div>
              </motion.div>
            </div>
          </div>
          <div className="border-t border-yellow-700 h-1 absolute top-[50%] w-full lg:w-[745px]"></div>
        </div>
      </div>
    </section>
  );
